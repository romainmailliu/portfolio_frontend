...
const bulletCheckStyles = [
  { fill: "#ecfdf5", stroke: "#6ee7b7", mark: "#059669" },
  { fill: "#eff6ff", stroke: "#93c5fd", mark: "#2563eb" },
  { fill: "#fffbeb", stroke: "#fcd34d", mark: "#d97706" },
] as const;

/** Compact hand-drawn check for list bullets */
export function SketchBulletCheck({
  className = "h-3.5 w-3.5 shrink-0",
  variant = 0,
}: SketchIconProps & { variant?: number }) {
  const style = bulletCheckStyles[variant % bulletCheckStyles.length];
